        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Home","Scholarships","About","Contact"].map((link) => (
                <li key={link}>
                  <Link
                    to={`/${link.toLowerCase()}`}
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["FAQ","Help Center","Privacy Policy","Terms of Service"].map((link) => (
                <li key={link}>
                  <Link
            ...
            <div className="flex space-x-3">
              {[
                ...
                <a
                  key={index}
                  href={social.href}
                  className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-800 hover:bg-gradient-to-r from-blue-500 to-purple-500 text-white transition-all duration-300"
                >
